...
Estimado/a {{ $sale->quote->customerOrder->customer->full_name}} espero que te encuentres muy bien, el motivo de mi correo es informarte que el dia de mañana es su fecha limite de pago.

Saldo $ {{number_format($balance,2,'.',',')}}

New Sun Travel **#CreamosMomentos**
