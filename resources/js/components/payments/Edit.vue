            ...
            <div class=" row justify-content-md-center">
              <div class="col-md-12 col-xl-12">
                <div class="card-header px-0 mt-2 bg-transparent clearfix">
                  <h4 class="float-left pt-2">Editar Pago:  {{this.payment.sale.quote.customer_order.customer.full_name}}</h4>
                  <div class="card-header-actions mr-1">
                    <a class="btn btn-primary" href="#" :disabled="submiting" @click.prevent="create">
                      <i class="fas fa-spinner fa-spin" v-if="submiting"></i>
                      <span class="ml-1 v-else"> Actualizar <i class="icon-check"></i></span>
                    </a>
                  </div>
                </div>
                <div class="col-md-12 card-body px-0">
                  <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <label>Importe <strong>({{payment.sale.quote.currency}})</strong></label>
                    ...
                    <div v-if="payment.sale.quote.currency != 'NACIONAL'" class="form-group col-md-3">
                    ...
                    <div v-if="payment.sale.quote.currency != 'NACIONAL' || payment.percentage > 0" class="form-group col-md-3">
                  ...
                  <div class="row float-right">
                    <div class="form-group col-md-12 float-right text h4">
                        ...
                        {{ payment.sale.price | currency }}<br>
  ...
  methods: {
      create () { 
        if (!this.submiting) {
          ...
          if(this.payment.sale.quote.currency == 'NACIONAL' && this.payment.percentage == 0){
            this.payment.real_price = this.payment.real_price_without_percentage = this.payment.price;
          }else if(this.payment.sale.quote.currency == 'NACIONAL' && this.payment.percentage > 0){
          ...
          this.payment.sale_id = this.payment.sale.id
          this.payment.customer_id = this.payment.sale.quote.customer_order.customer_id;
          let sale_id = this.payment.sale.id;


          
          this.submiting = true
          axios.put(`../../api/payments/update/${this.payment.id}`, this.payment)
          .then(response => {
      ...
      getPayment() {
          ...
          axios.get(`../../api/payments/get-payment/${res[3]}`)
            .then(response => {
                this.payment = response.data
                this.user_id = response.data.current_user.id;
                this.username = response.data.current_user.name;
                this.getPayments(this.payment.sale_id)
            })
            .catch(error => {
                this.$toasted.global.error('Pago no encontrado!')
      ...
      getPayments(id) {
          axios.get(`../../api/payments/get-payments-by-sale/` + id).then(response => {
              ...
              this.payment.balance = parseFloat(this.payment.sale.price - total);
          })
          .catch(error => {
              this.errors = error.response.data.errors
          })
