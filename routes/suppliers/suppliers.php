...
Route::middleware('auth')->group(function () {
    Route::group(['namespace' => 'Suppliers'], function() {
        ...
        Route::group(['prefix' => 'suppliers'], function() {
            ...
            Route::view('/track-supplier', 'suppliers.track')->middleware('permission:create-suppliers');
            Route::view('/{supplier}/edit', 'suppliers.edit')->middleware('permission:update-suppliers');
        });

        // api
        Route::group(['prefix' => 'api/suppliers'], function() {
            Route::get('/get-supplier/{supplier}', 'SupplierController@getSupplier');
            ...
            Route::post('/get-track', 'AssistantController@getTrack')->middleware('permission:create-suppliers');
            Route::post('/store', 'SupplierController@store')->middleware('permission:create-suppliers');
            Route::post('/store-track', 'AssistantController@storeTrack')->middleware('permission:create-suppliers');
            Route::post('/filter', 'SupplierController@filter')->middleware('permission:read-suppliers');
            Route::post('/upload', 'SupplierController@upload')->middleware('permission:read-suppliers');
            Route::post('/docs', 'SupplierController@getDocs')->middleware('permission:read-suppliers');
